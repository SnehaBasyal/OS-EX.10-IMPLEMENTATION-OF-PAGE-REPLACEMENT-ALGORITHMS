...
```
## OUTPUT:
![OS-EX.10-IMPLEMENTATION-OF-PAGE-REPLACEMENT-ALGORITHMS](os101.png)
...
```
## OUTPUT:
![OS-EX.10-IMPLEMENTATION-OF-PAGE-REPLACEMENT-ALGORITHMS](os102.png)
...
```
## OUTPUT:
![OS-EX.10-IMPLEMENTATION-OF-PAGE-REPLACEMENT-ALGORITHMS](os103.png)
